...
class IntroPageTests(unittest.TestCase):
    ...
    def test_footer(self):
        ...
        WebDriverWait(driver, 30).\
            until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".footer-links")))
        WebDriverWait(driver, 30).\
            until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".footer-extras")))
        WebDriverWait(driver, 30).\
